...
_core.ps.env.KRM_STAGE_CATALOGS_PATH = (_ps$env$KRM_STAGE_CAT = _core.ps.env.KRM_STAGE_CATALOGS_PATH) !== null && _ps$env$KRM_STAGE_CAT !== void 0 ? _ps$env$KRM_STAGE_CAT : defaults.stages.catalogs.path;
_core.ps.env.KRM_CATALOGS_PATH = _core.ps.env.KRM_STAGE_CATALOGS_PATH;
_core.ps.env.KRM_STAGE_CATALOG_NAME = (_ps$env$KRM_STAGE_CAT2 = _core.ps.env.KRM_STAGE_CATALOG_NAME) !== null && _ps$env$KRM_STAGE_CAT2 !== void 0 ? _ps$env$KRM_STAGE_CAT2 : "default";
_core.ps.env.KRM_CATALOG_NAME = _core.ps.env.KRM_STAGE_CATALOG_NAME;
