...
_core.ps.env.KRM_REGISTRY_GIT_BRANCH = (_ps$env$KRM_REGISTRY_2 = _core.ps.env.KRM_REGISTRY_GIT_BRANCH) !== null && _ps$env$KRM_REGISTRY_2 !== void 0 ? _ps$env$KRM_REGISTRY_2 : defaults.registry.git.branch;
_core.ps.env.KRM_REGISTRY_SKYNET_PORTAL = (_ps$env$KRM_REGISTRY_3 = _core.ps.env.KRM_REGISTRY_SKYNET_PORTAL) !== null && _ps$env$KRM_REGISTRY_3 !== void 0 ? _ps$env$KRM_REGISTRY_3 : defaults.registry.skynet.portal;
_core.ps.env.KRM_REGISTRY_SKYNET_SKYLINK = (_ps$env$KRM_REGISTRY_4 = _core.ps.env.KRM_REGISTRY_SKYNET_SKYLINK) !== null && _ps$env$KRM_REGISTRY_4 !== void 0 ? _ps$env$KRM_REGISTRY_4 : defaults.registry.skynet.skylink;
_core.ps.env.KRM_REGISTRY_SNS_PORTAL = (_ps$env$KRM_REGISTRY_5 = _core.ps.env.KRM_REGISTRY_SNS_PORTAL) !== null && _ps$env$KRM_REGISTRY_5 !== void 0 ? _ps$env$KRM_REGISTRY_5 : defaults.registry.sns.portal;
_core.ps.env.KRM_REGISTRY_SNS_PUBLIC_KEY = (_ps$env$KRM_REGISTRY_6 = _core.ps.env.KRM_REGISTRY_SNS_PUBLIC_KEY) !== null && _ps$env$KRM_REGISTRY_6 !== void 0 ? _ps$env$KRM_REGISTRY_6 : defaults.registry.sns.publicKey;
_core.ps.env.KRM_REGISTRY_SNS_NAME = (_ps$env$KRM_REGISTRY_7 = _core.ps.env.KRM_REGISTRY_SNS_NAME) !== null && _ps$env$KRM_REGISTRY_7 !== void 0 ? _ps$env$KRM_REGISTRY_7 : defaults.registry.sns.name;
_core.ps.env.KRM_REGISTRY_HTTP_HOST = (_ps$env$KRM_REGISTRY_8 = _core.ps.env.KRM_REGISTRY_HTTP_HOST) !== null && _ps$env$KRM_REGISTRY_8 !== void 0 ? _ps$env$KRM_REGISTRY_8 : defaults.registry.http.host;
_core.ps.env.KRM_REGISTRY_HTTP_BASE = (_ps$env$KRM_REGISTRY_9 = _core.ps.env.KRM_REGISTRY_HTTP_BASE) !== null && _ps$env$KRM_REGISTRY_9 !== void 0 ? _ps$env$KRM_REGISTRY_9 : defaults.registry.http.base;